...
def pinjam_buku():
    ...
    print(f"||{'No' : ^8}{'Judul Buku' : <15}".ljust(98)+"||")
    print("="*100)
    index = 1
    tampung_index = []
    for d in daftar_sementara:
        print(f"||{index : ^8}{d['Judul Buku'] : <15}".ljust(98)+"||")
    ...
    try:
        ...
        tampung_dict["Nama"] = input("Masukkan nama: ").title()
...
def view():
    ...
    try:
        ...
        pass
    print(f"||{'No' : ^6} {'Judul Buku' : <20}".ljust(98)+"||")
    print("="*100)
    index = 1
    for d in daftar_sementara:
        print(f"||{index : ^6} {d['Judul Buku'] : <20}".ljust(98)+"||")
        index += 1
    print("="*100)
    print("||"+"By  : @Ardin & @Yugo".center(96)+"||")
    print("="*100)
...
def read_data():
    ...
    print("="*123)
    print(f"||{'No' : ^5} {'Nama' : ^20} {'Judul Buku' : ^20} {'Tanggal Peminjaman' : ^28} {'Batas pengembalian' : ^17}".ljust(121)+"||")
    print("="*123)
    index = 1
    for d in daftar_sementara:
        print(f"||{index : ^6} {d['Nama'] : ^20} {d['Judul Buku'] : ^20} {d['Tanggal Peminjaman'] : ^26} {d['Batas pengembalian'] : >19}".ljust(121)+"||")
        index += 1
    print("="*123)
...
def update_data():
    ...
    try:
        ...
        tampung_dict["Judul Buku"] = input("Masukkan judul buku: ").title()
...
def baca_feedback():
    ...
    if uname in tampung_username:
        if pword in tampung_password:
            ...
            print(f"||{'No':^6}{'Nilai':^18}{'Komentar':<25}".ljust(78)+"||")
            print("="*80)
            index = 1
            for t in tampung_feedback:
                print(f"||{index:^6}{t['Nilai']:^18}{t['Komentar']:<25}".ljust(78)+"||")
                index += 1
            print("="*80)
            print("||"+"By  : @Ardin & @Yugo".center(76)+"||")
            print("="*80)
    else:
